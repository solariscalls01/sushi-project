...
export default function Home() {
  return (
    <div>
        <Header />
        <BackgroundImg />
        <Typography variant="h2" textAlign="center" justifyContent="center" sx={{ pb: "3rem", color: "black" }}>Welcome to Daimonji Sushi!</Typography>
        <Box sx={{ display: "flex", textAlign: "center", justifyContent: "center" }}>
          <Typography variant="body1" sx={{ pb: "3rem", width: "50%", textAlign: "center", justifyContent: "center", color: "black", fontSize: "1.5rem" }}>Welcome to Daimonji, where tradition meets innovation in every dish.
            ...
            <Typography variant="h6" sx={{ paddingTop: "1.1rem", color: "black", fontSize: "1.4rem", fontWeight: "bold" }} >
