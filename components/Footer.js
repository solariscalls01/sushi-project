                ...
                <Box sx={{ display: 'flex', justifyContent: 'center', mb: 2 }}>
                    ...
                    >
                        <BottomNavigationAction
                            ...
                            sx={{ color: '#fff', '&:hover': { color: '#fff' }, '&:active': { color: '#fff' }}}
                        />
                        <BottomNavigationAction
                            target='_blank'
                            rel='noopener noreferrer'
                            icon={<FontAwesomeIcon style={{ fontSize: '32px', color: '#fff' }} icon={faYelp} />}
                            href="https://www.yelp.com/biz/daimonji-japanese-restaurant-seattle"
                        />
                        <BottomNavigationAction
                            target='_blank'
                            rel='noopener noreferrer'
                            icon={<InstagramIcon sx={{fontSize: '32px', color:'#fff'}} />}
