    ...
    <div className={"flex flex-row gap-4 nav-links"}>
      {links.map((link) => (
        ...
        <Link
          ...
          href={link.href}
          className={clsx(
            "flex h-[48px] grow items-center justify-center gap-2 rounded-md p-3 text-sm md:text-lg font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3",
            {
